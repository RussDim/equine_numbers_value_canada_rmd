...
The mean horse population value was `r mean(horse_pop$Value)`
...
```{r plot horses, fig.width=10, fig.height=3, fig.cap= "Figure 1. Historical number of horses for each province in Canada",out.width='100%', fig.align = 'center'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap= "Figure2. Historical number of horses",out.width='100%', fig.align = 'center'}
province_plot <- horse_pop %>% 
  ...
  xlab("Year") +
  ylab("Number of horses") +
  ggtitle("Historical number of horses for British Columbia") +
  facet_grid(~GEO) +
  scale_y_continuous(labels = scales::comma) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
province_plot
...
```{r out.height= "200px", out.width="120px"}
knitr::include_graphics('plot province-1.png')
