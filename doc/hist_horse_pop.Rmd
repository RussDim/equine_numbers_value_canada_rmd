...
```{r plot horses, fig.cap= "Historical number of horses for each province in Canada",out.width='100%', fig.width=10, fig.height=3}
...
Below we zoom in and look at the province of Alberta (`r params$province`):

```{r plot province, fig.cap= "Historical number of horses per province in Canada",out.width='100%', fig.width=5, fig.height=4}
